...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=D12S31-1362957\\SQLEXPRESS;Database=VH_Burguer;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C5BC8FC6EC");
        ...
        {
            entity.HasKey(e => e.Log_AlteracaoProdutoID).HasName("PK__Log_Alte__D06C51B76F911A26");
        ...
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C33E81B610");
            ...
            entity.HasIndex(e => e.Nome, "UQ__Produto__7D8FE3B2712F7E57").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromocaoID).HasName("PK__Promocao__254B583D3F831C61");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79859F25EE1");

            entity.ToTable(tb => tb.HasTrigger("trg_ExclusaoUsuario"));

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534FBC9EADA").IsUnique();
